  ...
  <panel>
    <section class="policy">
      ...
      <ol class="points-list">
        <li class="points-list__point">
          Общие положения
          <p class="points-list__description">
          ...
          <ol class="subpoints-list">
            <li class="subpoints-list__subpoint">
        ...
        <li class="points-list__point">
          ...
          <ol class="subpoints-list">
            <li class="subpoints-list__subpoint">Фамилия, имя, отчество;</li>
            <li class="subpoints-list__subpoint">Электронный адрес;</li>
            <li class="subpoints-list__subpoint">Номера телефонов;</li>
            <li class="subpoints-list__subpoint">
              Год, месяц, дата и место рождения;
            </li>
            <li class="subpoints-list__subpoint">Фотографии;</li>
            <li class="subpoints-list__subpoint">
